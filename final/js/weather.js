...
const bethesda = 'https://api.openweathermap.org/data/2.5/onecall?lat=38.9859581&lon=-77.1282093&units=imperial&exclude=hourly,minutely&appid=bcbf0301f80c70e9e8f4bca6cd28a33f';

currentWeather('#bethesda', bethesda);



for (let day = 0; day < 3; day++) {
  // Runs 5 times, with values of step 0 through 4.
  forecast('#forecast', bethesda, day);
